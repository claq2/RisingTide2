...
class LocalAzureNetDataService implements IDataService {
...
RisingTideApp.factory(LocalAzureNetDataService.serviceId, ['$timeout', '$q', function ($timeout, $q) {
    return new LocalAzureNetDataService($timeout, $q);
}]);
